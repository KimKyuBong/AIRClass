...
def app():
    """main 앱 사용 (lifespan에서 DB가 올바른 루프로 초기화됨)"""
...
class TestEngagementTrackingEndpoints:
    ...
    def test_track_chat_endpoint_success(self, client):
    ...
    def test_track_quiz_response_endpoint_success(self, client):
...
class TestEngagementMetricsEndpoints:
    ...
    def test_get_session_engagement_endpoint(self, client):
    ...
    def test_get_student_engagement_endpoint(self, client):
    ...
    def test_get_session_stats_endpoint(self, client):
...
class TestEngagementCalculationEndpoints:
    ...
    def test_calculate_attention_score_endpoint(self, client):
    ...
    def test_calculate_participation_score_endpoint(self, client):
    ...
    def test_calculate_quiz_accuracy_endpoint(self, client):
    ...
    def test_calculate_overall_score_endpoint(self, client):
...
class TestConfusionDetectionEndpoint:
    ...
    def test_detect_confusion_endpoint(self, client):
...
class TestTrendAnalysisEndpoint:
    ...
    def test_analyze_trend_endpoint(self, client):
...
class TestHealthCheckEndpoint:
    ...
    def test_engagement_health_check(self, client):
...
class TestEndpointUrlPaths:
    ...
    def test_all_endpoints_reachable(self, client):
        ...
        for path, method in endpoints:
            ...
            # 200, 422, 503, 404만 허용 (500은 서버 오류이므로 실패)
